      ...
      <div className="flex w-full max-w-4xl items-center gap-16">
        ...
        <div className="flex-1">
          <svg viewBox="0 0 380 380" width="380" height="380" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Carte PNG via foreignObject */}
            <g filter="url(#shadow)" transform="rotate(6, 190, 165)">
              <foreignObject x="110" y="40" width="160" height="250">
                <img src="/navigo-card-transparent.png" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} />
              </foreignObject>
            </g>
          </svg>
        </div>
